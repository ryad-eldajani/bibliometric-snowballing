...
ALTER TABLE `quote`
  ADD CONSTRAINT `fk_quote_id_work_quoted` FOREIGN KEY (`doi_work`) REFERENCES `work` (`doi`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_quote_id_work` FOREIGN KEY (`doi_work_quoted`) REFERENCES `work` (`doi`) ON DELETE NO ACTION ON UPDATE NO ACTION;
